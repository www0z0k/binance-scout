...
class FarmerExt{
  constructor(fileName, port, pair){
    ...
    this.app.get('/plots', (req, res) => {
      ...
      page += `<p>${this.tickInterval / 60000}minutes</p>`;
...
//{"id":268893991,"price":"4523.21000000","qty":"0.01888200","quoteQty":"85.40725122","time":1584356745682,"isBuyerMaker":true,"isBestMatch":true}
    ...
    let orders = await this.client.futuresBook({ symbol: this.pair });
    this.data.arr.push({time: Date.now(), avg: avgPriceSrv, price: avgPriceWeighted, candles, orders});
